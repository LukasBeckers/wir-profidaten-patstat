...
class SimpleGMBHRemover():
    patterns_to_remove = [
        ...
        r"gmbh\.", r"gbr\.", r"mbh\.", r"\& co\.", r"kg\.", r"aktiengesellschaft\.", r"arbeitsgemeinschaft\.",
        r"g\.m\.b\.h\..", r"ag\.", r"kommanditgesellschaft\.", r"auf aktien\.", r"ug", r"haftungsbeschränkt", r"\(", r"\)", r"\&", r"co", r"e\.v\.", r";"
    ]
...
def clean_names():
    ...
    output_file = "./data/clean_profi_names.txt"
